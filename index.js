		...
		if (message.channel.type == "text") {
			...
			if (message.guild.id == "712382129673338991") {
				if (message.author.id == "351164483256975360") {
					...
					let embed = new Discord.MessageEmbed().setTitle(`Go study Kelly.`).setFooter(`I have told you ${data.count} times.`)
					message.reply(embed);
					if (extra != "") {
						message.channel.send(new Discord.MessageEmbed().setTitle(`New achievement: ${extra}`).setColor("#FFD700"))
					}
				}
			}
		}
