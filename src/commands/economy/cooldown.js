...
module.exports = {
    ...
    usage: `${module_1.prefix}cooldown`,
    perms: [],
    status: 'closed',
    async execute(message, args, other) {
        ...
        if (diff / 1000 < module_1.weeklycd * 60) {
            var cooldown = module_1.weeklycd - Math.floor(diff / 60000);
        ...
        var embed = new Discord.MessageEmbed()
            ...
            .addFields({ name: 'Hourly ', value: `${hourly}` }, { name: 'Daily', value: `${daily}` }, { name: 'Weekly', value: `${weekly}` })
            .setTimestamp()
